...
useEffect(() => {
    ...
    Axios.get(url+"/DENTSPLY/pdashboard", {
        ...
        console.log("project select response: ",response)
        
         for(let i=0;i<response.data.length;i++){
           // console.log(response.data[i].ProjectName,project,"ProjectName");
...
Axios.get(url+"/DENTSPLY/projectselectedit", {
...
if(response.data[i].ProjectName== project){
    ...
    history.push('/projectselectEdit')
}
...
console.log(Jobstate,"jobstate",resState,"resState",hrs,"hrs");
        Axios.get(url+"/DENTSPLY/projectedit",{
            params:{
           ...
           if(response.data.message==="Project Information saved")
        {
