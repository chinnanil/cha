...
import TaskListCreate from './tasklistCreate_CA';
...
if(response.data[i].UserId===user&&response.data[i].Date===localStorage.getItem("WeekDate"))
{
 
  this.props.history.push({pathname: '/SuperAdminTimesheetEdit_CA',
...
if(response.data.length>0&&this.state.k===2)
{
...
//alert(response.data[0].Client)
    ...
    const allItems = this.state.taskList;
    console.log("All Items as tasklist: ",allItems)
  ...
  console.log("employee group: ",employeeGroup)
    console.log("Submit TaskList",this.state.taskList)
    const country = localStorage.getItem("Country")
      Axios.post(url+"/DENTSPLY/superadmincreatetimesheet",{
       ...
       EmployeeGroup:employeeGroup,
        ...
        country:country
           ...
           if(response.data.message==="Timesheet saved for this period")
           {
...
if(validate){
  ...
  render() {
    ...
    //console.log("Tasklist: ",taskList)
     ...
     console.log("super admin data: ",myDate,user)
      //var myDate = localStorage.getItem("myDate");
      ...
      console.log("cureent",CurrentWeekDay,CurrentDate)
      ...
      // var WeekDate=   Moment(myDate).format('MMM DD yyyy')
                                  ...
                                  <thead>
                                      <tr>
                                        {k!==2?
                                          ...
                                          <th className="required">Prohect</th>
