...
return props.taskList.map((val,idx) => {
  ...
  if(val.day08==='' ) val.day08=0
  if(val.day09==='' ) val.day09=0
  if(val.day10==='' ) val.day10=0
  if(val.day11==='' ) val.day11=0
  if(val.day12==='' ) val.day12=0
  if(val.day13==='' ) val.day13=0
  if(val.day14==='' ) val.day14=0
//console.log("Hello",val.Cmt1,val.Cmt2)
let total=0;
   total=parseFloat(val.day01)+parseFloat(val.day02)+parseFloat(val.day03)+parseFloat(val.day04)+parseFloat(val.day05)+parseFloat(val.day06)+parseFloat(val.day07)+parseFloat(val.day08)+parseFloat(val.day09)+parseFloat(val.day10)+parseFloat(val.day11)+parseFloat(val.day12)+parseFloat(val.day13)+parseFloat(val.day14)
...
class Reports extends React.Component {
    ...
    ///console.log(window.myDate+"window.myDate")
     axios.get(url+"/"+country+"/TimeSheetReports",{
      
    }).then((response)=>{
     
      console.log(JSON.stringify(response)+"response reports")
      let LoginId = localStorage.getItem('LoginId');
      axios.get(url+"/"+country+"/User",{}).then((response1)=>{
        for(var i=0;i<response1.data.length;i++)
        {
          console.log(response1+"response1 user bi weekly")
...
let c=0;
        ...
        let key=response.data[j].Country+","+response.data[j].Location
          ...
          console.log(key+"key bi weekly")
          console.log(response.data[j].UserId+"  "+uname+"  "+response.data[j].Date+"  "+WeekDate+" "+response.data[j].Date+"  "+firstWeek)


        if(response.data[j].UserId===uname&&(response.data[j].Date===WeekDate||response.data[j].Date===firstWeek))
        {
...
for(let m=0;m<Types.length;m++)
{
  ...
  let  day14=STARR[14];
	  ...
	  let values={id:uname,username:Emp[1],Project:arr[0],Location:arr[1],WeeklyDate:WeekDate,Time_Type:Types[m],day01:day1,day02:day2,day03:day3,day04:day4,day05:day5,day06:day6,day07:day7,day08:day8,day09:day9,day10:day10,day11:day11,day12:day12,day13:day13,day14:day14};
  console.log(this.state.taskList[0].Day01)
    ...
    let values={id:"",username:"",Project:"",Location:arr[1],WeeklyDate:WeekDate,Time_Type:Types[m],day01:day1,day02:day2,day03:day3,day04:day4,day05:day5,day06:day6,day07:day7,day08:day8,day09:day9,day10:day10,day11:day11,day12:day12,day13:day13,day14:day14};
...
ConcatString[m]=concat;
          ...
          console.log(Array[1])
            ...
            day08=day08+parseFloat(Array[8]);
            day09=day09+parseFloat(Array[9]);
            day10=day10+parseFloat(Array[10]);
            day11=day11+parseFloat(Array[11]);
            day12=day12+parseFloat(Array[12]);
            day13=day13+parseFloat(Array[13]);
            day14=day14+parseFloat(Array[14]);
          }
         
          let values={id:"",username:"",Project:"",Location:arr[1],WeeklyDate:WeekDate,Time_Type:"Total Hours",day01:day01,day02:day02,day03:day03,day04:day04,day05:day05,day06:day06,day07:day07,day08:day08,day09:day09,day10:day10,day11:day11,day12:day12,day13:day13,day14:day14};
...
<th id="Day8">{Day8_str}</th>
<th id="Day9">{Day9_str}</th>
<th id="Day10">{Day10_str}</th>
<th id="Day11">{Day11_str}</th>
<th id="Day12">{Day12_str}</th>
<th id="Day13">{Day13_str}</th>
<th id="Day14">{Day14_str}</th>
<th>Total</th>
